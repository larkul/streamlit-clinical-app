...
DECLARE
    ...
    v_base_value_discovery DECIMAL := 63.37;  -- $63.37M at discovery
...
BEGIN
    ...
    SELECT
        CASE p_disease_area
            WHEN 'AUTOIMMUNE' THEN 2.5
            WHEN 'RARE_DISEASES' THEN 2.0
            WHEN 'ENDOCRINE' THEN 1.8
            WHEN 'ONCOLOGY' THEN 1.5
            WHEN 'CARDIOVASCULAR' THEN 1.3
            WHEN 'NEUROLOGY' THEN 1.4
            WHEN 'CNS' THEN 1.4
            WHEN 'RESPIRATORY' THEN 1.2
            WHEN 'GENITOURINARY' THEN 1.0
            WHEN 'OPHTHALMOLOGY' THEN 1.0
            WHEN 'INFECTIOUS_DISEASE' THEN 0.8
            WHEN 'VACCINES' THEN 0.8
            ELSE 1.0
    ...
    SELECT
        CASE p_phase
            WHEN 'DISCOVERY' THEN v_base_value_discovery / v_base_value_approval
            WHEN 'PHASE1' THEN 0.15
            WHEN 'PHASE2' THEN 0.30
            WHEN 'PHASE3' THEN 0.60
            WHEN 'FDA_REVIEW' THEN 0.85
            WHEN 'APPROVED' THEN 1.0
            ELSE v_base_value_discovery / v_base_value_approval
        END INTO v_phase_multiplier;

    RETURN v_base_value_approval * v_disease_multiplier * v_phase_multiplier;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    -- Study quality bonuses
    IF p_study_type ILIKE '%biomarker%' THEN
